...
// Add social media fields to the profile
...
// Display Author Box in articles
function spp_display_author_box($content) {
    if (is_singular('post')) {
        ...
        $social_profiles = [
            'Garuda' => ['link' => get_the_author_meta('social_garuda', $author_id), 'icon' => plugins_url('assets/icons/garuda.png', __FILE__)],
            'ORCID' => ['link' => get_the_author_meta('social_orcid', $author_id), 'icon' => plugins_url('assets/icons/orcid.png', __FILE__)],
            'Google Scholar' => ['link' => get_the_author_meta('social_scholar', $author_id), 'icon' => plugins_url('assets/icons/scholar.png', __FILE__)],
            'Scopus' => ['link' => get_the_author_meta('social_scopus', $author_id), 'icon' => plugins_url('assets/icons/scopus.png', __FILE__)],
            'Publon' => ['link' => get_the_author_meta('social_publon', $author_id), 'icon' => plugins_url('assets/icons/publon.svg', __FILE__)],
            'Web of Science' => ['link' => get_the_author_meta('social_wos', $author_id), 'icon' => plugins_url('assets/icons/wos.png', __FILE__)],
            'GitHub' => ['link' => get_the_author_meta('social_github', $author_id), 'icon' => plugins_url('assets/icons/github.png', __FILE__)],
            'Sinta' => ['link' => get_the_author_meta('social_sinta', $author_id), 'icon' => plugins_url('assets/icons/sinta.png', __FILE__)],
        ];
...
// Set default avatar size to 200px
